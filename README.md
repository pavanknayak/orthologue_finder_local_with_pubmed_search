...
This python program is an improvement off of the initial Gene list NCBI searcher I created, shown here: [EE282 Project](https://github.com/pavanknayak/ncbi_scraper/tree/master)
